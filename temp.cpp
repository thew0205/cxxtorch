...
#pragma GCC diagnostic pop
    ...
    public:
        ...
        _GLIBCXX23_CONSTEXPR explicit unique_ptr(_Up __p) noexcept
            : _M_t(__p)
        {
        }
    ...
    _GLIBCXX_NODISCARD _GLIBCXX23_CONSTEXPR inline bool
    ...
    _GLIBCXX23_CONSTEXPR inline compare_three_way_result_t<typename unique_ptr<_Tp, _Dp>::pointer,
                                                           typename unique_ptr<_Up, _Ep>::pointer>
    operator<=>(const unique_ptr<_Tp, _Dp> &__x,
                const unique_ptr<_Up, _Ep> &__y)
    {
...
#define __cpp_lib_make_unique 201304L
    ...
    _GLIBCXX23_CONSTEXPR inline __detail::__unique_ptr_t<_Tp>
     ...
     */
    template <typename _Tp>
    _GLIBCXX23_CONSTEXPR inline __detail::__unique_ptr_array_t<_Tp>
